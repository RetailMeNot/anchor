...
const ActionArea = () => (
    <CardActionArea backgroundColor={colors.silver.light}>
        <Grid columns={1}>
            <Cell width={1}>
                <Button variant="text" size="small">Some Action</Button>
            </Cell>
        </Grid>
    </CardActionArea>
);
        ...
        <StyledStory>
            <Grid columns="repeat(auto-fit, 200px)">
                {[1, 2, 3, 4, 5].map((index: number) => (
                    <Cell key={index}>
                        <Card>
                            <BrandCardContent title={`Brand Name ${index}`} key={index} />
                        </Card>
                    </Cell>
                ))}
            </Grid>
                ...
                {[1, 2, 3, 4, 5].map((index: number) => (
                    <Cell key={index}>
                        <Card actionArea={<ActionArea />}>
                            <WideCardContent title={`Wide Card ${index}`} key={index} />
                        </Card>
                    </Cell>
                ))}
            </Grid>
