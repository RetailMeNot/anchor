...
export const CustomAdaptor = ({ ...props }: CustomAdaptorProps) => <Responsive {...props} />;
...
export const LegacyTablet = ({ ...props }: FixedAdaptor) => (
  <Responsive {...props} minWidth={LegacyBreakpoints.tablet.min} maxWidth={LegacyBreakpoints.tablet.max} />
);
...
export const SM = ({ ...props }: FixedAdaptor) => (
  <Responsive {...props} minWidth={StandardBreakpoints.sm.min} maxWidth={StandardBreakpoints.sm.max} />
);
export const MD = ({ ...props }: FixedAdaptor) => (
  <Responsive {...props} minWidth={StandardBreakpoints.md.min} maxWidth={StandardBreakpoints.md.max} />
);
export const LG = ({ ...props }: FixedAdaptor) => (
  <Responsive {...props} minWidth={StandardBreakpoints.lg.min} maxWidth={StandardBreakpoints.lg.max} />
);
export const XL = ({ ...props }: FixedAdaptor) => (
  <Responsive {...props} minWidth={StandardBreakpoints.xl.min} maxWidth={StandardBreakpoints.xl.max} />
);
