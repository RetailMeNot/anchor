...
* `object`: The settings the user wishes to merge with a base theme object.
* `object`: the base theme object. Defaults to <Link to="/theme/root-theme">`RootTheme`</Link> if not
provided.
