...
few as you like. Be aware that all **Anchor** components and the <a href="https://www.smooth-code.com/open-source/xstyled/docs/responsive/#create-a-responsive-component" target="_blank">`breakpoints()`</a> function
will use those breakpoint keys/values.
