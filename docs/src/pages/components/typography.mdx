    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                you use one of <strong>Anchor</strong>'s <Link to="/theme/colors/">theme</Link> colors,
        ...
        <tr>
            <td>hue</td>
            <td>
                If the <pre>color</pre> prop is set to one of <strong>Anchor</strong>'s <Link to="/theme/colors/">theme</Link> colors,
