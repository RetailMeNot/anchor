...
The `Card` component is intended to be used to convey short pieces of information, such as offers.
They are designed to be relatively small in size, although **Anchor**'s `Card` component is very
flexible in this regard, expanding to accomodate whatever content is within it.
<br />
...
object for all of the examples to follow. Refer to the <Link to="/theme">theme</Link> section for
more information.
