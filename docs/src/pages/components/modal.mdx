...
import { ModalProvider, RootTheme } from '@retailmenot/anchor';
...
export const PageExample = () => (
    <StyledPageExample>
        <Typography as="h2" pt="0">An Example Page</Typography>
...
The `Modal` component is based off of `styled-react-modal` and as such accepts any of those <Typography as="a" href="https://github.com/AlexanderRichey/styled-react-modal#modal" target="_blank">props</Typography>.

<ApiTable data={[
    {
        property: 'background',
        description: <ColorBlurb background gradient label="Modal" />,
    ...
    {
        property: 'color',
        description: <ColorBlurb label="Modal" />,
        type: <FormatTypes data={['string', 'rgb', 'rgba']} noInterpret />,
    },
    {
        property: 'height',
...
<ApiTable data={[
    {
        property: 'background',
        description: <ColorBlurb background label="Header" />,
        type: <FormatTypes data={['string', 'rgb', 'rgba']} noInterpret />,
        default: 'white',
    },
    {
