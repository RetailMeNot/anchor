...
<ApiTable data={[
    ...
    {
        property: 'display',
        description: `Sets the CSS <pre>display</pre> property.`,
        type: 'string',
        default: 'inherit',
    },
    {
        ...
        description: `In this particular instance, the <pre>children</pre> of <pre>Skeleton</pre>
            are very important as they determine the size/shape. Note that using
            <pre>textLength</pre> will override the size of any child element, or the length of any
            text.`,
        type: 'any',
    },
    {
    ...
    {
        property: 'textLength',
        description: `The amount of text to replace with Skeleton blocks. This is useful for when
            you don't know how long the text will be, or if you don't have dummy-text ala Lorem
            Ipsum. Note that settings this prop will give it precedence over the content it
            contains.`,
        type: 'number',
    }
]} />